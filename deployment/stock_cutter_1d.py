...
'''
def StockCutter1D(child_rolls, parent_rolls, cutSide, output_json=True, large_model=True, cutStyle='exactCuts'):
  ...
  parent_width = parent_rolls[0][1] - cutSide
...
def drawGraph(consumed_big_rolls, child_rolls, parent_width,cutSide):
    import matplotlib.pyplot as plt
    import matplotlib.patches as patches

    print("cutSide1",cutSide)
